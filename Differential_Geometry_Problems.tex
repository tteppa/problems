...
\begin{enumerate}
	...
	\item Let $E \to M$ and $F \to N$ be vector bundles, and let $\varphi\colon E \to F$ be a smooth map. Suppose that the Euler vector field $V^E$ of $E$ is $\varphi$-related to the Euler vector field $V^F$ of $F$. Prove that $\varphi$ is actually a bundle homomorphism.
