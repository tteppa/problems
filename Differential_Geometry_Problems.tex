...
\begin{enumerate}
	...
	\]
	Show that $c'(0) = 0$, and deduce from this that $f \mapsto (f \circ c)''(0)$ defines an element of $T_pM$. Prove that this element is precisely $2[X, Y]_p$. (I need to double-check the sign and factor of $2$ on this one.)
